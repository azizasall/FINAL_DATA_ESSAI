...
# creons la cote de crédit du modéle 2
...
#---------> période d'expansion : 2000 et 2016 : dans le modèle 2 on ne change pas la référence
...
### prédiction en termes de firme_inv et firme_spec par le modele
predict_cote_credit_2016 <- predict(modele_2_2016, variables_2016_mod_2)
predict_cote_credit_2000 <- predict(modele_2_2000, variables_2000_mod_2)

### mettre cote à cote prediction à coté vrai vriables
head(data.frame(observed=variables_2016_mod_2$cote_credit_2016_mod_2, predicted=predict_cote_credit_2016), 20)
head(data.frame(observed=variables_2000_mod_2$cote_credit_2000_mod_2, predicted=predict_cote_credit_2000), 20)

### comparaison predictions qui sont tombées good par rapport au données de départ
sum(as.numeric(predict_cote_credit_2016==variables_2016_mod_2$cote_credit_2016_mod_2)) # 115 éléments qui ont été bien prédit par le modèle conformément aux données de départ sur 151 données au total
sum(as.numeric(predict_cote_credit_2000==variables_2000_mod_2$cote_credit_2000_mod_2))
...
prediction_table_2016_mod_2[1,2] <- mc_pourcentage_2016_mod_2[2,1]
prediction_table_2016_mod_2[2,2] <- mc_pourcentage_2016_mod_2[1,2]
prediction_table_2016_mod_2[3,1] <- mc_pourcentage_2016_mod_2[3,3]
...
prediction_table_2000_mod_2[3,1] <- mc_pourcentage_2000_mod_2[2,2]
prediction_table_2000_mod_2[4,1] <- bonne_classifcation_pourcentage_2000_mod_2

prediction_table_2000_mod_2[1,2] <- mc_pourcentage_2000_mod_2[2,1]
prediction_table_2000_mod_2[2,2] <- mc_pourcentage_2000_mod_2[1,2]
prediction_table_2000_mod_2[3,2] <- mc_pourcentage_2000_mod_2[1,2]
...
### prédiction en termes de firme_inv et firme_spec par le modele
predict_cote_credit_2019 <- predict(modele_2_2019, variables_2019_mod_2) # je ne vais pas interpréter ça un par un donc je le mets dans un tableau
predict_cote_credit_2018 <- predict(modele_2_2018, variables_2018_mod_2)
predict_cote_credit_2009 <- predict(modele_2_2009, variables_2009_mod_2)
predict_cote_credit_2008 <- predict(modele_2_2008, variables_2008_mod_2)
predict_cote_credit_2007 <- predict(modele_2_2007, variables_2007_mod_2)




### mettre cote à cote prediction à coté vrai vriables
head(data.frame(observed=variables_2019_mod_2$cote_credit_2019_mod_2, predicted=predict_cote_credit_2019), 20)
head(data.frame(observed=variables_2018_mod_2$cote_credit_2018_mod_2, predicted=predict_cote_credit_2018), 20)
head(data.frame(observed=variables_2009_mod_2$cote_credit_2009_mod_2, predicted=predict_cote_credit_2009), 20)
head(data.frame(observed=variables_2008_mod_2$cote_credit_2008_mod_2, predicted=predict_cote_credit_2008), 20)
head(data.frame(observed=variables_2007_mod_2$cote_credit_2007_mod_2, predicted=predict_cote_credit_2007), 20)

### comparaison predictions qui sont tombées good par rapport au données de départ
sum(as.numeric(predict_cote_credit_2019==variables_2019_mod_2$cote_credit_2019_mod_2)) # 115 éléments qui ont été bien prédit par le modèle conformément aux données de départ sur 151 données au total
sum(as.numeric(predict_cote_credit_2018==variables_2018_mod_2$cote_credit_2018_mod_2))
sum(as.numeric(predict_cote_credit_2009==variables_2009_mod_2$cote_credit_2009_mod_2))
sum(as.numeric(predict_cote_credit_2008==variables_2008_mod_2$cote_credit_2008_mod_2))
sum(as.numeric(predict_cote_credit_2007==variables_2007_mod_2$cote_credit_2007_mod_2))
...
prediction_table_2019_mod_2[1,2] <- mc_pourcentage_2019_mod_2[2,1]
prediction_table_2019_mod_2[2,2] <- mc_pourcentage_2019_mod_2[1,2]
prediction_table_2019_mod_2[3,2] <- mc_pourcentage_2019_mod_2[1,2]
...
# to delete 
# a ajuster ligne 2 et 3
prediction_table_2018_mod_2[1,2] <- mc_pourcentage_2018_mod_2[2,1]
prediction_table_2018_mod_2[2,2] <- mc_pourcentage_2018_mod_2[1,2]
prediction_table_2018_mod_2[3,2] <- mc_pourcentage_2018_mod_2[1,2]
...
# to delete 
# a ajuster ligne 2 et 3
prediction_table_2009_mod_2[1,2] <- mc_pourcentage_2009_mod_2[2,1]
prediction_table_2009_mod_2[2,2] <- mc_pourcentage_2009_mod_2[1,2]
prediction_table_2009_mod_2[3,2] <- mc_pourcentage_2009_mod_2[1,2]
...
# to delete 
# a ajuster ligne 2 et 3
prediction_table_2008_mod_2[1,2] <- mc_pourcentage_2008_mod_2[2,1]
prediction_table_2008_mod_2[2,2] <- mc_pourcentage_2008_mod_2[1,2]
prediction_table_2008_mod_2[3,2] <- mc_pourcentage_2008_mod_2[1,2]
...
prediction_table_2007_mod_2[1,2] <- mc_pourcentage_2007_mod_2[2,1]
prediction_table_2007_mod_2[2,2] <- mc_pourcentage_2007_mod_2[1,2]
prediction_table_2007_mod_2[3,2] <- mc_pourcentage_2007_mod_2[1,2]
