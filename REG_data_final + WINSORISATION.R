...
# ---> ridge : si colinéarité et qu'on veut garder toutes les variables :--> alpha = 0
# ---> lasso : fait automatiquement de la sélection de variables :--> alpha = 1
# ---> elastic net : fait de la sélection de variables et gère la colinéarité donc = combinaison de ridge et lasso :--> other alpha
...
response_2016 <- variables_2016_mod_3$cote_credit_2016_mod_3
other_var_2016 <- variables_2016_mod_3[4:ncol(variables_2016_mod_3)]
variables_2016_reg_pen <- cbind(response_2016, other_var_2016)

x_2016 = model.matrix(response_2016 ~ . , data = variables_2016_reg_pen)[,-1]

# to delete 
# x_2016 = model.matrix(response_2016 ~ Marge_sur_EBITDA +
#                         Rendement_sur_cap_prop  +
#                         ratio_ben_avt_impot_sur_frais_int + ratio_B_non_rep_sur_Tot_actif +
#                         ratio_tot_dette_sur_tot_actif + ratio_Flux_de_TR_expl_sur_passif_cour +
#                         ratio_Fonds_de_roulement_sur_tot_actif +
#                         Total_actif + volatilite_annuelle, data = variables_2016_reg_pen)[,-1]  # --> [,-1] pour enlever l'intercepte


y_2016 = variables_2016_reg_pen$response_2016

# elastic_net from lab4

# (1)
par(mfrow = c(1,2))

elastic_net_model_2016_ungrouped <-  glmnet(x_2016, y_2016, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped")
plot(elastic_net_model_2016_ungrouped, xvar = 'lambda')
...
set.seed(2021)
cv_elastic_net_2016_ungrouped <-  cv.glmnet(x_2016, y_2016, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped", nfolds = 10)
cv_elastic_net_2016_ungrouped$lambda.min
cv_elastic_net_2016_ungrouped$lambda.1se
plot(cv_elastic_net_2016_ungrouped)
...
coef(cv_elastic_net_2016_ungrouped, s = "lambda.1se")

# matrice de confusion: ON USE ONLY 1se not min
response_2016_prob_ungrouped <- predict(cv_elastic_net_2016_ungrouped, x_2016, s = "lambda.1se", type="class")
response_2016_prob_ungrouped <- factor(response_2016_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
mc_2016_ungrouped <- table(response_2016_prob_ungrouped, variables_2016_reg_pen$response_2016)

# TABLE ACCURARY & MISCLASSIFICATION
mc_pourcentage_2016_ungrouped <- mc_2016_ungrouped / colSums(mc_2016_ungrouped)

### MISCLASSIFICATION pour présentation output
#### Pourcentage de mauvaise classification (misclassifaction)
miscalsification_pourcentage_2016_ungrouped <- 1- sum(diag(mc_2016_ungrouped))/sum(mc_2016_ungrouped) # from mc : (14 + 22) / 151

### ACCURACY DU MODEL pour présentation output
### Pourcenttage de bonne classification : la somme de la diag qu'on divise par le nombre total d'observation 
bonne_classifcation_pourcentage_2016_ungrouped <- sum(diag(mc_2016_ungrouped))/sum(mc_2016_ungrouped) 

# vérification
# MISCLASSIFICATION + ACCURACY DU MODEL
miscalsification_pourcentage_2016_ungrouped+bonne_classifcation_pourcentage_2016_ungrouped

# TABLE DE PRECISION
# ungrouped
prediction_table_2016_ungrouped_reg_pen <- matrix(0,6, 2)
colnames(prediction_table_2016_ungrouped_reg_pen) <- c("Prediction_correcte_2016_en_%", "Prediction_incorrecte_en_%")
rownames(prediction_table_2016_ungrouped_reg_pen) <- c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC", "Precision_Globale_de_la_Prediction")

prediction_table_2016_ungrouped_reg_pen[1,1] <- mc_pourcentage_2016_ungrouped[1,1]
prediction_table_2016_ungrouped_reg_pen[2,1] <- mc_pourcentage_2016_ungrouped[2,2]
prediction_table_2016_ungrouped_reg_pen[3,1] <- mc_pourcentage_2016_ungrouped[3,3]
prediction_table_2016_ungrouped_reg_pen[4,1] <- mc_pourcentage_2016_ungrouped[4,4]
prediction_table_2016_ungrouped_reg_pen[5,1] <- mc_pourcentage_2016_ungrouped[5,5]
prediction_table_2016_ungrouped_reg_pen[6,1] <- bonne_classifcation_pourcentage_2016_ungrouped

prediction_table_2016_ungrouped_reg_pen[1,2] <- 1 - mc_pourcentage_2016_ungrouped[1,1]
prediction_table_2016_ungrouped_reg_pen[2,2] <- 1 - mc_pourcentage_2016_ungrouped[2,2]
prediction_table_2016_ungrouped_reg_pen[3,2] <- 1 - mc_pourcentage_2016_ungrouped[3,3]
prediction_table_2016_ungrouped_reg_pen[4,2] <- 1 - mc_pourcentage_2016_ungrouped[4,4]
prediction_table_2016_ungrouped_reg_pen[5,2] <- 1 - mc_pourcentage_2016_ungrouped[5,5]
prediction_table_2016_ungrouped_reg_pen[6,2] <- bonne_classifcation_pourcentage_2016_ungrouped

round(prediction_table_2016_ungrouped_reg_pen * 100, digits = 2)
...
library("ggplot2")
library("caret")
variables_2016_reg_pen$response_2016 <- factor(variables_2016_reg_pen$response_2016, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
response_2016_prob_ungrouped <- factor(response_2016_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
confusionMatrix(data=response_2016_prob_ungrouped, reference=variables_2016_reg_pen$response_2016)



# 2000

response_2000 <- variables_2000_mod_3$cote_credit_2000_mod_3
other_var_2000 <- variables_2000_mod_3[4:ncol(variables_2000_mod_3)]
variables_2000_reg_pen <- cbind(response_2000, other_var_2000)

x_2000 = model.matrix(response_2000 ~ . , data = variables_2000_reg_pen)[,-1]
y_2000 = variables_2000_reg_pen$response_2000
...
elastic_net_model_2000_ungrouped <-  glmnet(x_2000, y_2000, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped")
plot(elastic_net_model_2000_ungrouped, xvar = 'lambda')

# (2) --> meilleur lamda sélectionné à partir de cross validation
# Afin de choisir la valeur pour le paramètre d'ajustement ?? avec une 10-validation croisée, on utilise la méthode cv.glmnet:
set.seed(2021)
cv_elastic_net_2000_ungrouped <-  cv.glmnet(x_2000, y_2000, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped", nfolds = 10)
cv_elastic_net_2000_ungrouped$lambda.min
cv_elastic_net_2000_ungrouped$lambda.1se
plot(cv_elastic_net_2000_ungrouped)


# MODELE QU'ON OBTIENT & POINTS = VARIABLES NON SELECTIONNEES

# Si on utilise le lambda qui correspond à la plus grande valeur de lambda telle que le MSE est à l'intérieur d'une erreur standard du minimum (la ligne vertical à la droite), on obtient un modèle avec entre [7 et 3] variables ()!:
coef(cv_elastic_net_2000_ungrouped, s = "lambda.1se")

# matrice de confusion: ON USE ONLY 1se not min
response_2000_prob_ungrouped <- predict(cv_elastic_net_2000_ungrouped, x_2000, s = "lambda.1se", type="class")
response_2000_prob_ungrouped <- factor(response_2000_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
mc_2000_ungrouped <- table(response_2000_prob_ungrouped, variables_2000_reg_pen$response_2000)

# TABLE ACCURARY & MISCLASSIFICATION
mc_pourcentage_2000_ungrouped <- mc_2000_ungrouped / colSums(mc_2000_ungrouped)

### MISCLASSIFICATION pour présentation output
#### Pourcentage de mauvaise classification (misclassifaction)
miscalsification_pourcentage_2000_ungrouped <- 1- sum(diag(mc_2000_ungrouped))/sum(mc_2000_ungrouped) # from mc : (14 + 22) / 151

### ACCURACY DU MODEL pour présentation output
### Pourcenttage de bonne classification : la somme de la diag qu'on divise par le nombre total d'observation 
bonne_classifcation_pourcentage_2000_ungrouped <- sum(diag(mc_2000_ungrouped))/sum(mc_2000_ungrouped) 

# vérification
# MISCLASSIFICATION + ACCURACY DU MODEL
miscalsification_pourcentage_2000_ungrouped+bonne_classifcation_pourcentage_2000_ungrouped

# TABLE DE PRECISION
# ungrouped
prediction_table_2000_ungrouped_reg_pen <- matrix(0,6, 2)
colnames(prediction_table_2000_ungrouped_reg_pen) <- c("Prediction_correcte_2016_en_%", "Prediction_incorrecte_en_%")
rownames(prediction_table_2000_ungrouped_reg_pen) <- c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC", "Precision_Globale_de_la_Prediction")

prediction_table_2000_ungrouped_reg_pen[1,1] <- mc_pourcentage_2000_ungrouped[1,1]
prediction_table_2000_ungrouped_reg_pen[2,1] <- mc_pourcentage_2000_ungrouped[2,2]
prediction_table_2000_ungrouped_reg_pen[3,1] <- mc_pourcentage_2000_ungrouped[3,3]
prediction_table_2000_ungrouped_reg_pen[4,1] <- mc_pourcentage_2000_ungrouped[4,4]
prediction_table_2000_ungrouped_reg_pen[5,1] <- mc_pourcentage_2000_ungrouped[5,5]
prediction_table_2000_ungrouped_reg_pen[6,1] <- bonne_classifcation_pourcentage_2000_ungrouped

prediction_table_2000_ungrouped_reg_pen[1,2] <- 1 - mc_pourcentage_2000_ungrouped[1,1]
prediction_table_2000_ungrouped_reg_pen[2,2] <- 1 - mc_pourcentage_2000_ungrouped[2,2]
prediction_table_2000_ungrouped_reg_pen[3,2] <- 1 - mc_pourcentage_2000_ungrouped[3,3]
prediction_table_2000_ungrouped_reg_pen[4,2] <- 1 - mc_pourcentage_2000_ungrouped[4,4]
prediction_table_2000_ungrouped_reg_pen[5,2] <- 1 - mc_pourcentage_2000_ungrouped[5,5]
prediction_table_2000_ungrouped_reg_pen[6,2] <- bonne_classifcation_pourcentage_2000_ungrouped

round(prediction_table_2000_ungrouped_reg_pen * 100, digits = 2)
...
library("ggplot2")
library("caret")
variables_2000_reg_pen$response_2000 <- factor(variables_2000_reg_pen$response_2000, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
response_2000_prob_ungrouped <- factor(response_2000_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
confusionMatrix(data=response_2000_prob_ungrouped, reference=variables_2000_reg_pen$response_2000)
...
elastic_net_model_2019_ungrouped <-  glmnet(x_2019, y_2019, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped")
plot(elastic_net_model_2019_ungrouped, xvar = 'lambda')

# (2) --> meilleur lamda sélectionné à partir de cross validation
# Afin de choisir la valeur pour le paramètre d'ajustement ?? avec une 10-validation croisée, on utilise la méthode cv.glmnet:
set.seed(2021)
cv_elastic_net_2019_ungrouped <-  cv.glmnet(x_2019, y_2019, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped", nfolds = 10)
cv_elastic_net_2019_ungrouped$lambda.min
cv_elastic_net_2019_ungrouped$lambda.1se
plot(cv_elastic_net_2019_ungrouped)


# MODELE QU'ON OBTIENT & POINTS = VARIABLES NON SELECTIONNEES

# Si on utilise le lambda qui correspond à la plus grande valeur de lambda telle que le MSE est à l'intérieur d'une erreur standard du minimum (la ligne vertical à la droite), on obtient un modèle avec entre [7 et 3] variables ()!:
coef(cv_elastic_net_2019_ungrouped, s = "lambda.1se")

# matrice de confusion: ON USE ONLY 1se not min
response_2019_prob_ungrouped <- predict(cv_elastic_net_2019_ungrouped, x_2019, s = "lambda.1se", type="class")
...
response_2018 <- variables_2018_mod_3$cote_credit_2018_mod_3
other_var_2018 <- variables_2018_mod_3[4:ncol(variables_2018_mod_3)]
variables_2018_reg_pen <- cbind(response_2018, other_var_2018)

x_2018 = model.matrix(response_2018 ~ . , data = variables_2018_reg_pen)[,-1]
y_2018 = variables_2018_reg_pen$response_2018
...
elastic_net_model_2018_ungrouped <-  glmnet(x_2018, y_2018, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped")
plot(elastic_net_model_2018_ungrouped, xvar = 'lambda')

# (2) --> meilleur lamda sélectionné à partir de cross validation
# Afin de choisir la valeur pour le paramètre d'ajustement ?? avec une 10-validation croisée, on utilise la méthode cv.glmnet:
set.seed(2021)
cv_elastic_net_2018_ungrouped <-  cv.glmnet(x_2018, y_2018, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped", nfolds = 10)
cv_elastic_net_2018_ungrouped$lambda.min
cv_elastic_net_2018_ungrouped$lambda.1se
plot(cv_elastic_net_2018_ungrouped)


# MODELE QU'ON OBTIENT & POINTS = VARIABLES NON SELECTIONNEES

# Si on utilise le lambda qui correspond à la plus grande valeur de lambda telle que le MSE est à l'intérieur d'une erreur standard du minimum (la ligne vertical à la droite), on obtient un modèle avec entre [7 et 3] variables ()!:
coef(cv_elastic_net_2018_ungrouped, s = "lambda.1se")

# matrice de confusion: ON USE ONLY 1se not min
response_2018_prob_ungrouped <- predict(cv_elastic_net_2018_ungrouped, x_2018, s = "lambda.1se", type="class")
response_2018_prob_ungrouped <- factor(response_2018_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
mc_2018_ungrouped <- table(response_2018_prob_ungrouped, variables_2018_reg_pen$response_2018)

# TABLE ACCURARY & MISCLASSIFICATION
mc_pourcentage_2018_ungrouped <- mc_2018_ungrouped / colSums(mc_2018_ungrouped)

### MISCLASSIFICATION pour présentation output
#### Pourcentage de mauvaise classification (misclassifaction)
miscalsification_pourcentage_2018_ungrouped <- 1- sum(diag(mc_2018_ungrouped))/sum(mc_2018_ungrouped) # from mc : (14 + 22) / 151

### ACCURACY DU MODEL pour présentation output
### Pourcenttage de bonne classification : la somme de la diag qu'on divise par le nombre total d'observation 
bonne_classifcation_pourcentage_2018_ungrouped <- sum(diag(mc_2018_ungrouped))/sum(mc_2018_ungrouped) 

# vérification
# MISCLASSIFICATION + ACCURACY DU MODEL
miscalsification_pourcentage_2018_ungrouped+bonne_classifcation_pourcentage_2018_ungrouped

# TABLE DE PRECISION
# ungrouped
prediction_table_2018_ungrouped_reg_pen <- matrix(0,6, 2)
colnames(prediction_table_2018_ungrouped_reg_pen) <- c("Prediction_correcte_2016_en_%", "Prediction_incorrecte_en_%")
rownames(prediction_table_2018_ungrouped_reg_pen) <- c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC", "Precision_Globale_de_la_Prediction")

prediction_table_2018_ungrouped_reg_pen[1,1] <- mc_pourcentage_2018_ungrouped[1,1]
prediction_table_2018_ungrouped_reg_pen[2,1] <- mc_pourcentage_2018_ungrouped[2,2]
prediction_table_2018_ungrouped_reg_pen[3,1] <- mc_pourcentage_2018_ungrouped[3,3]
prediction_table_2018_ungrouped_reg_pen[4,1] <- mc_pourcentage_2018_ungrouped[4,4]
prediction_table_2018_ungrouped_reg_pen[5,1] <- mc_pourcentage_2018_ungrouped[5,5]
prediction_table_2018_ungrouped_reg_pen[6,1] <- bonne_classifcation_pourcentage_2018_ungrouped

prediction_table_2018_ungrouped_reg_pen[1,2] <- 1 - mc_pourcentage_2018_ungrouped[1,1]
prediction_table_2018_ungrouped_reg_pen[2,2] <- 1 - mc_pourcentage_2018_ungrouped[2,2]
prediction_table_2018_ungrouped_reg_pen[3,2] <- 1 - mc_pourcentage_2018_ungrouped[3,3]
prediction_table_2018_ungrouped_reg_pen[4,2] <- 1 - mc_pourcentage_2018_ungrouped[4,4]
prediction_table_2018_ungrouped_reg_pen[5,2] <- 1 - mc_pourcentage_2018_ungrouped[5,5]
prediction_table_2018_ungrouped_reg_pen[6,2] <- bonne_classifcation_pourcentage_2018_ungrouped

round(prediction_table_2018_ungrouped_reg_pen * 100, digits = 2)
...
library("ggplot2")
library("caret")
variables_2018_reg_pen$response_2018 <- factor(variables_2018_reg_pen$response_2018, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
response_2018_prob_ungrouped <- factor(response_2018_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
confusionMatrix(data=response_2018_prob_ungrouped, reference=variables_2018_reg_pen$response_2018)



# 2009

response_2009 <- variables_2009_mod_3$cote_credit_2009_mod_3
other_var_2009 <- variables_2009_mod_3[4:ncol(variables_2009_mod_3)]
variables_2009_reg_pen <- cbind(response_2009, other_var_2009)

x_2009 = model.matrix(response_2009 ~ . , data = variables_2009_reg_pen)[,-1]
y_2009 = variables_2009_reg_pen$response_2009
...
elastic_net_model_2009_ungrouped <-  glmnet(x_2009, y_2009, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped")
plot(elastic_net_model_2009_ungrouped, xvar = 'lambda')

# (2) --> meilleur lamda sélectionné à partir de cross validation
# Afin de choisir la valeur pour le paramètre d'ajustement ?? avec une 10-validation croisée, on utilise la méthode cv.glmnet:
set.seed(2021)
cv_elastic_net_2009_ungrouped <-  cv.glmnet(x_2009, y_2009, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped", nfolds = 10)
cv_elastic_net_2009_ungrouped$lambda.min
cv_elastic_net_2009_ungrouped$lambda.1se
plot(cv_elastic_net_2009_ungrouped)


# MODELE QU'ON OBTIENT & POINTS = VARIABLES NON SELECTIONNEES

# Si on utilise le lambda qui correspond à la plus grande valeur de lambda telle que le MSE est à l'intérieur d'une erreur standard du minimum (la ligne vertical à la droite), on obtient un modèle avec entre [7 et 3] variables ()!:
coef(cv_elastic_net_2009_ungrouped, s = "lambda.1se")

# matrice de confusion: ON USE ONLY 1se not min
response_2009_prob_ungrouped <- predict(cv_elastic_net_2009_ungrouped, x_2009, s = "lambda.1se", type="class")
response_2009_prob_ungrouped <- factor(response_2009_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
mc_2009_ungrouped <- table(response_2009_prob_ungrouped, variables_2009_reg_pen$response_2009)

# TABLE ACCURARY & MISCLASSIFICATION
mc_pourcentage_2009_ungrouped <- mc_2009_ungrouped / colSums(mc_2009_ungrouped)

### MISCLASSIFICATION pour présentation output
#### Pourcentage de mauvaise classification (misclassifaction)
miscalsification_pourcentage_2009_ungrouped <- 1- sum(diag(mc_2009_ungrouped))/sum(mc_2009_ungrouped) # from mc : (14 + 22) / 151

### ACCURACY DU MODEL pour présentation output
### Pourcenttage de bonne classification : la somme de la diag qu'on divise par le nombre total d'observation 
bonne_classifcation_pourcentage_2009_ungrouped <- sum(diag(mc_2009_ungrouped))/sum(mc_2009_ungrouped) 

# vérification
# MISCLASSIFICATION + ACCURACY DU MODEL
miscalsification_pourcentage_2009_ungrouped+bonne_classifcation_pourcentage_2009_ungrouped

# TABLE DE PRECISION
# ungrouped
prediction_table_2009_ungrouped_reg_pen <- matrix(0,6, 2)
colnames(prediction_table_2009_ungrouped_reg_pen) <- c("Prediction_correcte_2016_en_%", "Prediction_incorrecte_en_%")
rownames(prediction_table_2009_ungrouped_reg_pen) <- c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC", "Precision_Globale_de_la_Prediction")

prediction_table_2009_ungrouped_reg_pen[1,1] <- mc_pourcentage_2009_ungrouped[1,1]
prediction_table_2009_ungrouped_reg_pen[2,1] <- mc_pourcentage_2009_ungrouped[2,2]
prediction_table_2009_ungrouped_reg_pen[3,1] <- mc_pourcentage_2009_ungrouped[3,3]
prediction_table_2009_ungrouped_reg_pen[4,1] <- mc_pourcentage_2009_ungrouped[4,4]
prediction_table_2009_ungrouped_reg_pen[5,1] <- mc_pourcentage_2009_ungrouped[5,5]
prediction_table_2009_ungrouped_reg_pen[6,1] <- bonne_classifcation_pourcentage_2009_ungrouped

prediction_table_2009_ungrouped_reg_pen[1,2] <- 1 - mc_pourcentage_2009_ungrouped[1,1]
prediction_table_2009_ungrouped_reg_pen[2,2] <- 1 - mc_pourcentage_2009_ungrouped[2,2]
prediction_table_2009_ungrouped_reg_pen[3,2] <- 1 - mc_pourcentage_2009_ungrouped[3,3]
prediction_table_2009_ungrouped_reg_pen[4,2] <- 1 - mc_pourcentage_2009_ungrouped[4,4]
prediction_table_2009_ungrouped_reg_pen[5,2] <- 1 - mc_pourcentage_2009_ungrouped[5,5]
prediction_table_2009_ungrouped_reg_pen[6,2] <- bonne_classifcation_pourcentage_2009_ungrouped

round(prediction_table_2009_ungrouped_reg_pen * 100, digits = 2)
...
library("ggplot2")
library("caret")
variables_2009_reg_pen$response_2009 <- factor(variables_2009_reg_pen$response_2009, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
response_2009_prob_ungrouped <- factor(response_2009_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
confusionMatrix(data=response_2009_prob_ungrouped, reference=variables_2009_reg_pen$response_2009)



# 2008

response_2008 <- variables_2008_mod_3$cote_credit_2008_mod_3
other_var_2008 <- variables_2008_mod_3[4:ncol(variables_2008_mod_3)]
variables_2008_reg_pen <- cbind(response_2008, other_var_2008)

x_2008 = model.matrix(response_2008 ~ . , data = variables_2008_reg_pen)[,-1]
y_2008 = variables_2008_reg_pen$response_2008
...
elastic_net_model_2008_ungrouped <-  glmnet(x_2008, y_2008, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped")
plot(elastic_net_model_2008_ungrouped, xvar = 'lambda')

# (2) --> meilleur lamda sélectionné à partir de cross validation
# Afin de choisir la valeur pour le paramètre d'ajustement ?? avec une 10-validation croisée, on utilise la méthode cv.glmnet:
set.seed(2021)
cv_elastic_net_2008_ungrouped <-  cv.glmnet(x_2008, y_2008, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped", nfolds = 10)
cv_elastic_net_2008_ungrouped$lambda.min
cv_elastic_net_2008_ungrouped$lambda.1se
plot(cv_elastic_net_2008_ungrouped)


# MODELE QU'ON OBTIENT & POINTS = VARIABLES NON SELECTIONNEES

# Si on utilise le lambda qui correspond à la plus grande valeur de lambda telle que le MSE est à l'intérieur d'une erreur standard du minimum (la ligne vertical à la droite), on obtient un modèle avec entre [7 et 3] variables ()!:
coef(cv_elastic_net_2008_ungrouped, s = "lambda.1se")

# matrice de confusion: ON USE ONLY 1se not min
response_2008_prob_ungrouped <- predict(cv_elastic_net_2008_ungrouped, x_2008, s = "lambda.1se", type="class")
response_2008_prob_ungrouped <- factor(response_2008_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
mc_2008_ungrouped <- table(response_2008_prob_ungrouped, variables_2008_reg_pen$response_2008)

# TABLE ACCURARY & MISCLASSIFICATION
mc_pourcentage_2008_ungrouped <- mc_2008_ungrouped / colSums(mc_2008_ungrouped)

### MISCLASSIFICATION pour présentation output
#### Pourcentage de mauvaise classification (misclassifaction)
miscalsification_pourcentage_2008_ungrouped <- 1- sum(diag(mc_2008_ungrouped))/sum(mc_2008_ungrouped) # from mc : (14 + 22) / 151

### ACCURACY DU MODEL pour présentation output
### Pourcenttage de bonne classification : la somme de la diag qu'on divise par le nombre total d'observation 
bonne_classifcation_pourcentage_2008_ungrouped <- sum(diag(mc_2008_ungrouped))/sum(mc_2008_ungrouped) 

# vérification
# MISCLASSIFICATION + ACCURACY DU MODEL
miscalsification_pourcentage_2008_ungrouped+bonne_classifcation_pourcentage_2008_ungrouped

# TABLE DE PRECISION
# ungrouped
prediction_table_2008_ungrouped_reg_pen <- matrix(0,6, 2)
colnames(prediction_table_2008_ungrouped_reg_pen) <- c("Prediction_correcte_2016_en_%", "Prediction_incorrecte_en_%")
rownames(prediction_table_2008_ungrouped_reg_pen) <- c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC", "Precision_Globale_de_la_Prediction")

prediction_table_2008_ungrouped_reg_pen[1,1] <- mc_pourcentage_2008_ungrouped[1,1]
prediction_table_2008_ungrouped_reg_pen[2,1] <- mc_pourcentage_2008_ungrouped[2,2]
prediction_table_2008_ungrouped_reg_pen[3,1] <- mc_pourcentage_2008_ungrouped[3,3]
prediction_table_2008_ungrouped_reg_pen[4,1] <- mc_pourcentage_2008_ungrouped[4,4]
prediction_table_2008_ungrouped_reg_pen[5,1] <- mc_pourcentage_2008_ungrouped[5,5]
prediction_table_2008_ungrouped_reg_pen[6,1] <- bonne_classifcation_pourcentage_2008_ungrouped

prediction_table_2008_ungrouped_reg_pen[1,2] <- 1 - mc_pourcentage_2008_ungrouped[1,1]
prediction_table_2008_ungrouped_reg_pen[2,2] <- 1 - mc_pourcentage_2008_ungrouped[2,2]
prediction_table_2008_ungrouped_reg_pen[3,2] <- 1 - mc_pourcentage_2008_ungrouped[3,3]
prediction_table_2008_ungrouped_reg_pen[4,2] <- 1 - mc_pourcentage_2008_ungrouped[4,4]
prediction_table_2008_ungrouped_reg_pen[5,2] <- 1 - mc_pourcentage_2008_ungrouped[5,5]
prediction_table_2008_ungrouped_reg_pen[6,2] <- bonne_classifcation_pourcentage_2008_ungrouped

round(prediction_table_2008_ungrouped_reg_pen * 100, digits = 2)
...
library("ggplot2")
library("caret")
variables_2008_reg_pen$response_2008 <- factor(variables_2008_reg_pen$response_2008, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
response_2008_prob_ungrouped <- factor(response_2008_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
confusionMatrix(data=response_2008_prob_ungrouped, reference=variables_2008_reg_pen$response_2008)



# 2007

response_2007 <- variables_2007_mod_3$cote_credit_2007_mod_3
other_var_2007 <- variables_2007_mod_3[4:ncol(variables_2007_mod_3)]
variables_2007_reg_pen <- cbind(response_2007, other_var_2007)

x_2007 = model.matrix(response_2007 ~ . , data = variables_2007_reg_pen)[,-1]
y_2007 = variables_2007_reg_pen$response_2007
...
elastic_net_model_2007_ungrouped <-  glmnet(x_2007, y_2007, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped")
plot(elastic_net_model_2007_ungrouped, xvar = 'lambda')

# (2) --> meilleur lamda sélectionné à partir de cross validation
# Afin de choisir la valeur pour le paramètre d'ajustement ?? avec une 10-validation croisée, on utilise la méthode cv.glmnet:
set.seed(2021)
cv_elastic_net_2007_ungrouped <-  cv.glmnet(x_2007, y_2007, alpha = 0.8, family = "multinomial", type.multinomial = "ungrouped", nfolds = 10)
cv_elastic_net_2007_ungrouped$lambda.min
cv_elastic_net_2007_ungrouped$lambda.1se
plot(cv_elastic_net_2007_ungrouped)


# MODELE QU'ON OBTIENT & POINTS = VARIABLES NON SELECTIONNEES

# Si on utilise le lambda qui correspond à la plus grande valeur de lambda telle que le MSE est à l'intérieur d'une erreur standard du minimum (la ligne vertical à la droite), on obtient un modèle avec entre [7 et 3] variables ()!:
coef(cv_elastic_net_2007_ungrouped, s = "lambda.1se")

# matrice de confusion: ON USE ONLY 1se not min
response_2007_prob_ungrouped <- predict(cv_elastic_net_2007_ungrouped, x_2007, s = "lambda.1se", type="class")
response_2007_prob_ungrouped <- factor(response_2007_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
mc_2007_ungrouped <- table(response_2007_prob_ungrouped, variables_2007_reg_pen$response_2007)

# TABLE ACCURARY & MISCLASSIFICATION
mc_pourcentage_2007_ungrouped <- mc_2007_ungrouped / colSums(mc_2007_ungrouped)

### MISCLASSIFICATION pour présentation output
#### Pourcentage de mauvaise classification (misclassifaction)
miscalsification_pourcentage_2007_ungrouped <- 1- sum(diag(mc_2007_ungrouped))/sum(mc_2007_ungrouped) # from mc : (14 + 22) / 151

### ACCURACY DU MODEL pour présentation output
### Pourcenttage de bonne classification : la somme de la diag qu'on divise par le nombre total d'observation 
bonne_classifcation_pourcentage_2007_ungrouped <- sum(diag(mc_2007_ungrouped))/sum(mc_2007_ungrouped) 

# vérification
# MISCLASSIFICATION + ACCURACY DU MODEL
miscalsification_pourcentage_2007_ungrouped+bonne_classifcation_pourcentage_2007_ungrouped

# TABLE DE PRECISION
# ungrouped
prediction_table_2007_ungrouped_reg_pen <- matrix(0,6, 2)
colnames(prediction_table_2007_ungrouped_reg_pen) <- c("Prediction_correcte_2016_en_%", "Prediction_incorrecte_en_%")
rownames(prediction_table_2007_ungrouped_reg_pen) <- c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC", "Precision_Globale_de_la_Prediction")

prediction_table_2007_ungrouped_reg_pen[1,1] <- mc_pourcentage_2007_ungrouped[1,1]
prediction_table_2007_ungrouped_reg_pen[2,1] <- mc_pourcentage_2007_ungrouped[2,2]
prediction_table_2007_ungrouped_reg_pen[3,1] <- mc_pourcentage_2007_ungrouped[3,3]
prediction_table_2007_ungrouped_reg_pen[4,1] <- mc_pourcentage_2007_ungrouped[4,4]
prediction_table_2007_ungrouped_reg_pen[5,1] <- mc_pourcentage_2007_ungrouped[5,5]
prediction_table_2007_ungrouped_reg_pen[6,1] <- bonne_classifcation_pourcentage_2007_ungrouped

prediction_table_2007_ungrouped_reg_pen[1,2] <- 1 - mc_pourcentage_2007_ungrouped[1,1]
prediction_table_2007_ungrouped_reg_pen[2,2] <- 1 - mc_pourcentage_2007_ungrouped[2,2]
prediction_table_2007_ungrouped_reg_pen[3,2] <- 1 - mc_pourcentage_2007_ungrouped[3,3]
prediction_table_2007_ungrouped_reg_pen[4,2] <- 1 - mc_pourcentage_2007_ungrouped[4,4]
prediction_table_2007_ungrouped_reg_pen[5,2] <- 1 - mc_pourcentage_2007_ungrouped[5,5]
prediction_table_2007_ungrouped_reg_pen[6,2] <- bonne_classifcation_pourcentage_2007_ungrouped

round(prediction_table_2007_ungrouped_reg_pen * 100, digits = 2)
...
library("ggplot2")
library("caret")
variables_2007_reg_pen$response_2007 <- factor(variables_2007_reg_pen$response_2007, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
response_2007_prob_ungrouped <- factor(response_2007_prob_ungrouped, levels = c("AAA_&_AA", "A", "BBB", "BB", "B_&_CCC"))
confusionMatrix(data=response_2007_prob_ungrouped, reference=variables_2007_reg_pen$response_2007)
