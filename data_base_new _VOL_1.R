...
# importer vol_30D
library(readxl)
VOLATILITY_1_454 <- read_excel("C:/Users/aziza/Desktop/Projet de fin d'études en gestion financière/data_traiement_dans_R/FINAL_DATA/FINAL_DATA/FINAL_DATA_ESSAI/VOLATILITY_#_1_454.xlsx", 
                               col_names = FALSE)
##View(VOLATILITY_1_454)

vol.1 <- VOLATILITY_1_454[6:29,1:ncol(VOLATILITY_1_454)]
##View(vol.1)
...
vol_names <- VOLATILITY_1_454[6, 3:12]
dim(vol_names)
...
vol_names <- matrix(vol_names, 1,10)
...
vol_2000.1 <- vol_2000[,3:ncol(vol_2000)] 
vol_2007.1 <- vol_2007[,3:ncol(vol_2007)] 
vol_2008.1 <- vol_2008[,3:ncol(vol_2008)] 
vol_2009.1 <- vol_2009[,3:ncol(vol_2009)] 
vol_2016.1 <- vol_2016[,3:ncol(vol_2016)] 
...
vol_2000.2 <- matrix(vol_2000.1, 410, 10, byrow = TRUE)
vol_2007.2 <- matrix(vol_2007.1, 410, 10, byrow = TRUE)
vol_2008.2 <- matrix(vol_2008.1, 410, 10, byrow = TRUE)
vol_2009.2 <- matrix(vol_2009.1, 410, 10, byrow = TRUE)
vol_2016.2 <- matrix(vol_2016.1, 410, 10, byrow = TRUE)
vol_2018.2 <- matrix(vol_2018.1, 410, 10, byrow = TRUE)
vol_2019.2 <- matrix(vol_2019.1, 410, 10, byrow = TRUE)
...
vol_2000.2.df <- as.data.frame(vol_2000.2)
colnames(vol_2000.2.df) <- vol_names
##fix(vol_2000.2.df)

vol_2007.2.df <- as.data.frame(vol_2007.2)
colnames(vol_2007.2.df) <- vol_names
##fix(vol_2007.2.df)

vol_2008.2.df <- as.data.frame(vol_2008.2)
colnames(vol_2008.2.df) <- vol_names
##fix(vol_2008.2.df)

vol_2009.2.df <- as.data.frame(vol_2009.2)
colnames(vol_2009.2.df) <- vol_names
##fix(vol_2009.2.df)

vol_2016.2.df <- as.data.frame(vol_2016.2)
colnames(vol_2016.2.df) <- vol_names
##fix(vol_2016.2.df)

vol_2018.2.df <- as.data.frame(vol_2018.2)
colnames(vol_2018.2.df) <- vol_names
##fix(vol_2018.2.df)

vol_2019.2.df <- as.data.frame(vol_2019.2)
colnames(vol_2019.2.df) <- vol_names
##fix(vol_2019.2.df)
...
# ajout de la colonne vol

data_2000.2.df_vol <- cbind(data_2000.2.df, vol_30D=matrix(vol_2000.2.df$VOLATILITY_30D))
dim(data_2000.2.df_vol)


data_2007.2.df_vol <- cbind(data_2007.2.df, vol_30D=matrix(vol_2007.2.df$VOLATILITY_30D))
dim(data_2007.2.df_vol)


data_2008.2.df_vol <- cbind(data_2008.2.df, vol_30D=matrix(vol_2008.2.df$VOLATILITY_30D))
dim(data_2008.2.df_vol)


data_2009.2.df_vol <- cbind(data_2009.2.df, vol_30D=matrix(vol_2009.2.df$VOLATILITY_30D))
dim(data_2009.2.df_vol)


data_2016.2.df_vol <- cbind(data_2016.2.df, vol_30D=matrix(vol_2016.2.df$VOLATILITY_30D))
dim(data_2016.2.df_vol)


data_2018.2.df_vol <- cbind(data_2018.2.df, vol_30D=matrix(vol_2018.2.df$VOLATILITY_30D))
dim(data_2018.2.df_vol)


data_2019.2.df_vol <- cbind(data_2019.2.df, vol_30D=matrix(vol_2019.2.df$VOLATILITY_30D))
dim(data_2019.2.df_vol)
...
data_2000.2.df <- data_2000.2.df_vol
data_2007.2.df <- data_2007.2.df_vol
data_2008.2.df <- data_2008.2.df_vol
data_2009.2.df <- data_2009.2.df_vol
data_2016.2.df <- data_2016.2.df_vol
data_2018.2.df <- data_2018.2.df_vol
data_2019.2.df <- data_2019.2.df_vol
...
data_2000.3.df <- data_2000.2.df_rat[rowSums(is.na(data_2000.2.df_rat))<37,]  
...
data_2007.3.df <- data_2007.2.df_rat[rowSums(is.na(data_2007.2.df_rat))<37,]
dim(data_2007.3.df)
plot_missing(data_2007.3.df)

data_2008.3.df <- data_2008.2.df_rat[rowSums(is.na(data_2008.2.df_rat))<37,]
dim(data_2008.3.df)
plot_missing(data_2008.3.df)

data_2009.3.df <- data_2009.2.df_rat[rowSums(is.na(data_2009.2.df_rat))<37,]
dim(data_2009.3.df)
plot_missing(data_2009.3.df)

data_2016.3.df <- data_2016.2.df_rat[rowSums(is.na(data_2016.2.df_rat))<37,]
dim(data_2016.3.df)
plot_missing(data_2016.3.df)

data_2018.3.df <- data_2018.2.df_rat[rowSums(is.na(data_2018.2.df_rat))<37,]
dim(data_2018.3.df)
plot_missing(data_2018.3.df)

data_2019.3.df <- data_2019.2.df_rat[rowSums(is.na(data_2019.2.df_rat))<37,]
dim(data_2019.3.df)
plot_missing(data_2019.3.df)
...
variables_names_2 <- c("RATINGS", variables_names, "vol_30D")
...
sum(is.na(data_2000.3.df_x$vol_30D))
...
#### enlever ici vol_30, continuer même régle après le remttre après avoir enlever all columns

dim(data_2000.3.df)
vol_30D_2000 <- data_2000.3.df$vol_30D
data_2000.3.df <- data_2000.3.df[-37]
dim(data_2000.3.df)


dim(data_2007.3.df)
vol_30D_2007 <- data_2007.3.df$vol_30D
data_2007.3.df <- data_2007.3.df[-37]
dim(data_2007.3.df)


dim(data_2008.3.df)
vol_30D_2008 <- data_2008.3.df$vol_30D
data_2008.3.df <- data_2008.3.df[-37]
dim(data_2008.3.df)


dim(data_2009.3.df)
vol_30D_2009 <- data_2009.3.df$vol_30D
data_2009.3.df <- data_2009.3.df[-37]
dim(data_2009.3.df)


dim(data_2016.3.df)
vol_30D_2016 <- data_2016.3.df$vol_30D
data_2016.3.df <- data_2016.3.df[-37]
dim(data_2016.3.df)


dim(data_2018.3.df)
vol_30D_2018 <- data_2018.3.df$vol_30D
data_2018.3.df <- data_2018.3.df[-37]
dim(data_2018.3.df)


dim(data_2019.3.df)
vol_30D_2019 <- data_2019.3.df$vol_30D
data_2019.3.df <- data_2019.3.df[-37]
dim(data_2019.3.df)
...
data_2000.4.df_x <- data_2000.3.df[ ,colSums(is.na(data_2000.3.df))<166]
...
data_2007.4.df_x <- data_2007.3.df[ ,colSums(is.na(data_2007.3.df))<210] # 210
...
data_2008.4.df_x <- data_2008.3.df[ ,colSums(is.na(data_2008.3.df))<213] #213
...
data_2009.4.df_x <- data_2009.3.df[ ,colSums(is.na(data_2009.3.df))<217] #217
...
data_2016.4.df_x <- data_2016.3.df[ ,colSums(is.na(data_2016.3.df))<241] #241
...
data_2018.4.df_x <- data_2018.3.df[ ,colSums(is.na(data_2018.3.df))<243] # 243
...
data_2019.4.df_x <- data_2019.3.df[ ,colSums(is.na(data_2019.3.df))<243] # 243
...
# remettre vol_30D avant de faire remove paar line
data_2000.4.df_x <- cbind(data_2000.4.df_x, vol_30D=matrix(vol_30D_2000))
data_2007.4.df_x <- cbind(data_2007.4.df_x, vol_30D=matrix(vol_30D_2007))
data_2008.4.df_x <- cbind(data_2008.4.df_x, vol_30D=matrix(vol_30D_2008))
data_2009.4.df_x <- cbind(data_2009.4.df_x, vol_30D=matrix(vol_30D_2009))
data_2016.4.df_x <- cbind(data_2016.4.df_x, vol_30D=matrix(vol_30D_2016))
data_2018.4.df_x <- cbind(data_2018.4.df_x, vol_30D=matrix(vol_30D_2018))
data_2019.4.df_x <- cbind(data_2019.4.df_x, vol_30D=matrix(vol_30D_2019))
...
data_2000.4.df <- data_2000.4.df_x[rowSums(is.na(data_2000.4.df_x))<11,]  
...
dim(data_2007.4.df_x) # nrow = 20 donc 20/2 = 10 donc si une ligne à plus de 10 cases vides, je le delete
data_2007.4.df <- data_2007.4.df_x[rowSums(is.na(data_2007.4.df_x))<11,]
fix(data_2007.4.df)



dim(data_2008.4.df_x) # nrow = 20 donc 20/2 = 10 donc si une ligne à plus de 10 cases vides, je le delete
data_2008.4.df <- data_2008.4.df_x[rowSums(is.na(data_2008.4.df_x))<11,]
fix(data_2008.4.df)


dim(data_2009.4.df_x)# nrow = 21 donc  21/2 = 11 donc si une ligne à plus de 11 cases vides, je le delete
data_2009.4.df <- data_2009.4.df_x[rowSums(is.na(data_2009.4.df_x))<11,]
fix(data_2009.4.df)


dim(data_2016.4.df_x) # nrow = 21 donc 21/2 = 10 donc si une ligne à plus de 10 cases vides, je le delete
data_2016.4.df <- data_2016.4.df_x[rowSums(is.na(data_2016.4.df_x))<11,]
fix(data_2016.4.df)



dim(data_2018.4.df_x) # nrow = 24 donc 24/2 = 12 donc si une ligne à plus de 12 cases vides, je le delete
data_2018.4.df <- data_2018.4.df_x[rowSums(is.na(data_2018.4.df_x))<13,]
fix(data_2018.4.df)



dim(data_2019.4.df_x) # nrow = 23 donc 23/2 = 12 donc si une ligne à plus de 12 cases vides, je le delete
...
vol_30D_2000 <- final_clean_dataset_2000$vol_30D
vol_30D_2007 <- final_clean_dataset_2007$vol_30D
vol_30D_2008 <- final_clean_dataset_2008$vol_30D
vol_30D_2009 <- final_clean_dataset_2009$vol_30D
vol_30D_2016 <- final_clean_dataset_2016$vol_30D
vol_30D_2018 <- final_clean_dataset_2018$vol_30D
vol_30D_2019 <- final_clean_dataset_2019$vol_30D

#fix(vol_30D_2000)

# importer data vol_30D

#write.csv(vol_30D_2000, file = "vol_30D_2000.csv")
#write.csv(vol_30D_2007, file = "vol_30D_2007.csv")
#write.csv(vol_30D_2008, file = "vol_30D_2008.csv")
#write.csv(vol_30D_2009, file = "vol_30D_2009.csv")
#write.csv(vol_30D_2016, file = "vol_30D_2016.csv")
#write.csv(vol_30D_2018, file = "vol_30D_2018.csv")
#write.csv(vol_30D_2019, file = "vol_30D_2019.csv")
...
nom_col_good_2000 <- c("Cote_crédit_num", "Cote_crédit", "RATINGS", "Marge_bénéficiaire nette",
                  ...
                  "ratio_Flux_de_TR_expl_sur_passif_cour","ratio_Fonds_de_roulement_sur_tot_actif", "vol_30D")
...
matrice_comparaison_nom_var_1_2000 <- matrix(nom_col_2000, 24, 1)
matrice_comparaison_nom_var_2_2000 <- matrix(nom_col_good_2000, 24, 1)
...
#juste pour des fins de comparaisons
matrice_comparaison_nom_var_1_2007 <- matrix(nom_col_2007, 25, 1)
matrice_comparaison_nom_var_2_2007 <- matrix(nom_col_good_2007, 25, 1)
...
#juste pour des fins de comparaisons
matrice_comparaison_nom_var_1_2008 <- matrix(nom_col_2008, 25, 1)
matrice_comparaison_nom_var_2_2008 <- matrix(nom_col_good_2008, 25, 1)
...
#juste pour des fins de comparaisons
matrice_comparaison_nom_var_1_2009 <- matrix(nom_col_2009, 27, 1)
matrice_comparaison_nom_var_2_2009 <- matrix(nom_col_good_2009, 27, 1)
...
#juste pour des fins de comparaisons
matrice_comparaison_nom_var_1_2016 <- matrix(nom_col_2016, 27, 1)
matrice_comparaison_nom_var_2_2016 <- matrix(nom_col_good_2016, 27, 1)
...
#juste pour des fins de comparaisons
matrice_comparaison_nom_var_1_2018 <- matrix(nom_col_2018, 30, 1)
matrice_comparaison_nom_var_2_2018 <- matrix(nom_col_good_2018, 30, 1)
...
#juste pour des fins de comparaisons
matrice_comparaison_nom_var_1_2019 <- matrix(nom_col_2019, 29, 1)
matrice_comparaison_nom_var_2_2019 <- matrix(nom_col_good_2019, 29, 1)
